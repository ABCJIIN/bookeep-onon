const todayBookData = [
  {
    id: 0,
    img: "../assets/api/images/finedust.png",
    title: "미세먼지",
  ...
  {
    id: 1,
    img: "../assets/api/images/scissors.png",
    title: "아홉수 가위",
    author: "범유진",
    publisher: "안전가옥",
    price: "9000원",
  ...
  {
    id: 2,
    img: "../assets/api/images/captainhoney.png",
  ...
  {
    id: 3,
    img: "../assets/api/images/cocktail.png",
    title: "칵테일, 러브, 좀비",
    author: "조예은",
    publisher: "안전가옥",
    price: "9000 원",
  ...
  {
    id: 4,
    img: "../assets/api/images/friday.png",
    title: "땡스 갓, 잇츠 프라이데이",
    author: "심너울",
    publisher: "안전가옥",
    price: "9000원",
  ...
  {
    id: 5,
    img: "../assets/api/images/punch.png",
    title: "사뭇 강펀치",
    author: "설재인",
    publisher: "안전가옥",
    price: "9000원",
